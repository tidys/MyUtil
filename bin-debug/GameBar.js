 ...
 *
 */
var GameBar = (function (_super) {
    __extends(GameBar, _super);
    function GameBar(_type, pt1, pt2) {
        _super.call(this, _type, pt1, pt2);
        var bg = new egret.Bitmap(RES.getRes("game.panelBg"));
        bg.x = -264;
        bg.y = -31;
        this.addChild(bg);
    ...
    var d = __define,c=GameBar,p=c.prototype;
    p.setData = function (lv, money, goal) {
...
egret.registerClass(GameBar,'GameBar');
